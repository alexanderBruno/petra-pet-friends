                    ...
                    <div class="form-group media">
                      ...
                      <div class="media-body">
                        <div class="form-group editprofile_postprivacy_group">
                          ...
                          <input name="editprofile_postprivacy" type="radio" value=1 <?php if ($user->posts_privacy==1) echo "checked"; ?>> Tothom.
                          <input name="editprofile_postprivacy" type="radio" value=2 <?php if ($user->posts_privacy==2) echo "checked"; ?>> Només les meves amistats.
                        </div>
                      </div>
